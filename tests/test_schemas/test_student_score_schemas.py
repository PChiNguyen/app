...
def test_create_student_score_success(mock_student: Student, mock_assessment_template: AssessmentTemplate):
...
def test_create_student_score_score_constraints(invalid_score, mock_student: Student, mock_assessment_template: AssessmentTemplate):
